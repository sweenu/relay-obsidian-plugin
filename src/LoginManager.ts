					...
					return fail(
                                ...
                                try {
                                        ...
                                        try {
                                                ...
                                                const errorText = `${error?.message ?? ""} ${error?.originalError?.message ?? ""}`.toLowerCase();
                                                if (errorText.includes("invalid_grant") || errorText.includes("code not found")) {
